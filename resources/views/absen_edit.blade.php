...
<body>
    <div class="card p-4 text-dark">
        <h4 class="fw-bold mb-4 text-center">Update Data: {{ $data->name }}</h4>
        ...
        <form action="/absen/update/{{ $data->id }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="d-grid gap-2 mt-4">
                <button type="submit" class="btn btn-warning py-2 fw-bold">Update Perubahan</button>
